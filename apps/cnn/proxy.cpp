...
int main(int argc, char* argv[]) {
    ...
    resortedMatrix = RST(matrix, matrix_col_size, matrix_row_size, window_size, window_size, resortedMatrix);
    ...
    mmaxParams = ((uint64_t)matrix_size << 16) + (uint64_t) window_size;
